...
# READING IN DATA AND CREATING DATA FRAMES FOR EACH GROUP
  group=c("ldrc_[0-9]_[0-9][0-9][0-9]", "ldrc_*second", "ldrc_*third", "ldrc2_[0-9]_[0-9][0-9][0-9]","ldrc2_*second*", "ldrc3_[0-9]_[0-9][0-9][0-9]", "PHILIPS/H_LD*_[0-9]", "H_LD*_[0-9]_second", "H_LD*_[0-9]_third", "LDFHO*_[0-2]", "LDFHO*_second", "LDFHO2*_1_3","ldrc*_c_[0-9][0-9][0-9]*", "PHILIPS/H_LD*[0-9][0-9][0-9][0-9]", "H_LD*_c_second", "H_LD*_c_third")
  ...
  # REMOVE REPEATED BUTTON PRESSES
    ...
    dat_all_15=dat_all_15[dat_all_15$rep==FALSE,]
...
# ALL GROUPS DFs
  ...
  # RUN 
    ...
    all_run_med = rbind(run_sub_med_1, run_sub_med_2, run_sub_med_3, run_sub_med_4, run_sub_med_5, run_sub_med_6, run_sub_med_7, run_sub_med_8, run_sub_med_9, run_sub_med_10, run_sub_med_11, run_sub_med_12, run_sub_med_13, run_sub_med_14, run_sub_med_15, run_sub_med_16)
    ...
    all_sub_mean = rbind(sub_mean_1, sub_mean_2, sub_mean_3, sub_mean_4, sub_mean_5, sub_mean_6, sub_mean_7, sub_mean_8, sub_mean_9, sub_mean_10, sub_mean_11, sub_mean_12, sub_mean_13, sub_mean_14, sub_mean_15, sub_mean_16)
  ...
  # CONDITION
    ...
    all_sub_cond_med = rbind(cond_sub_med_1, cond_sub_med_2, cond_sub_med_3, cond_sub_med_4, cond_sub_med_5, cond_sub_med_6, cond_sub_med_7, cond_sub_med_8, cond_sub_med_9, cond_sub_med_10, cond_sub_med_11, cond_sub_med_12, cond_sub_med_13,  cond_sub_med_13, cond_sub_med_14, cond_sub_med_15, cond_sub_med_16)
    ...
    all_cond_mean = rbind(cond_group_mean_1, cond_group_mean_2, cond_group_mean_3, cond_group_mean_4, cond_group_mean_5, cond_group_mean_6, cond_group_mean_7, cond_group_mean_8, cond_group_mean_9, cond_group_mean_10, cond_group_mean_11, cond_group_mean_12, cond_group_mean_13, cond_group_mean_14, cond_group_mean_15, cond_group_mean_16)
...
# LARGE DATA FRAME OF ALL SUBS
      ...
      #MAKE SUBGROUP THAT WENT INTO WU PROCESSING 9/15
      all_sub_mean_wu = all_sub_mean[all_sub_mean$group2!="third" & all_sub_mean$group!="H_first" & all_sub_mean$group!="H_control_first" & all_sub_mean$group!="H_control_third",]
      all_sub_mean_wu = all_sub_mean_wu[all_sub_mean_wu$subind!="ldrc_1_007" & all_sub_mean_wu$subind!="ldrc2_0_123" & all_sub_mean_wu$subind!="ldrc2_0_172" & all_sub_mean_wu$subind!="ldrc2_1_129" & all_sub_mean_wu$subind!="ldrc2_1_139" & all_sub_mean_wu$subind!="ldrc2_1_152" & all_sub_mean_wu$subind!="ldrc_0_013_second",]

      all_sub_mean_wu$subind[all_sub_mean_wu$group=="A_second"]=substrLeft(all_sub_mean_wu$subind[all_sub_mean_wu$group=="A_second"],10)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="A2_second"]=substrLeft(all_sub_mean_wu$subind[all_sub_mean_wu$group=="A2_second"],11)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="A_control" | all_sub_mean_wu$group=="A_first" | all_sub_mean_wu$group=="A_second" | all_sub_mean_wu$group=="A2_first" | all_sub_mean_wu$group=="A2_second"]=substrRight(all_sub_mean_wu$subind[all_sub_mean_wu$group=="A_control" | all_sub_mean_wu$group=="A_first" | all_sub_mean_wu$group=="A_second" | all_sub_mean_wu$group=="A2_first" | all_sub_mean_wu$group=="A2_second"],5)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_second"]=substrLeft(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_second"],13)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_second"]=substrRight(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_second"],6)  
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H2_second"]=substrLeft(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H2_second"],12)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_control_second"]=substrLeft(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_control_second"],13)
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H2_first" | all_sub_mean_wu$group=="H2_second"]=substrRight(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H2_first" | all_sub_mean_wu$group=="H2_second"],7) 
      all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_control_second"]= substrRight(all_sub_mean_wu$subind[all_sub_mean_wu$group=="H_control_second"],6)     
      all_sub_mean_wu$city = 'austin'
      all_sub_mean_wu$city[grep('H', all_sub_mean_wu$group)] = 'houston'
      all_sub_mean_wu$ID = substrLeft(all_sub_mean_wu$subind, 1)
      all_sub_mean_wu$ID[grep('control', all_sub_mean_wu$group)] ="c"
      all_sub_mean_wu$ID2 = all_sub_mean_wu$ID
      all_sub_mean_wu$ID2[all_sub_mean_wu$ID == "2"] = "1"
      all_sub_mean_wu$rep = 'u'
      all_sub_mean_wu$rep[(duplicated(all_sub_mean_wu['subind'])) | (duplicated(all_sub_mean_wu['subind'], fromLast = TRUE))] = 'r'

      write.csv(all_sub_mean_wu, file=sprintf("%s/data_frames/SC/all_subs_mean_wu.csv", wd), na="NA", row.names=FALSE)
      ...
      all_sub_mean$subind[all_sub_mean$group=="A_control" | all_sub_mean$group=="A_first" | all_sub_mean$group=="A3_first" | all_sub_mean$group=="A_second" | all_sub_mean$group=="A_third" | all_sub_mean$group=="A2_first" | all_sub_mean$group=="A2_second"]=substrRight(all_sub_mean$subind[all_sub_mean$group=="A_control" | all_sub_mean$group=="A_first" | all_sub_mean$group=="A3_first" | all_sub_mean$group=="A_second" | all_sub_mean$group=="A_third" | all_sub_mean$group=="A2_first" | all_sub_mean$group=="A2_second"],5)
      all_sub_mean$subind[all_sub_mean$subind=="187_2"] = "c_187"
      ...
      all_sub_mean$subind[all_sub_mean$group=="H3_first"]=substrLeft(all_sub_mean$subind[all_sub_mean$group=="H3_first"],12)
      ...
      all_sub_mean$subind[all_sub_mean$group=="H2_first" | all_sub_mean$group=="H3_first" | all_sub_mean$group=="H2_second"]=substrRight(all_sub_mean$subind[all_sub_mean$group=="H2_first" | all_sub_mean$group=="H3_first" | all_sub_mean$group=="H2_second"],7) 
    ...
    # BY CONDITION
      all_sub_cond_med = rbind(cond_sub_med_1, cond_sub_med_2, cond_sub_med_3, cond_sub_med_4, cond_sub_med_5, cond_sub_med_6, cond_sub_med_7, cond_sub_med_8, cond_sub_med_9, cond_sub_med_10, cond_sub_med_11, cond_sub_med_12, cond_sub_med_13,  cond_sub_med_14,  cond_sub_med_15,  cond_sub_med_16)
      ...
      all_sub_cond_med$subind[all_sub_cond_med$group=="A_control" | all_sub_cond_med$group=="A_first" | all_sub_cond_med$group=="A_second" | all_sub_cond_med$group=="A_third" | all_sub_cond_med$group=="A2_first" | all_sub_cond_med$group=="A2_second"| all_sub_cond_med$group=="A3_first" ]=substrRight(all_sub_cond_med$subind[all_sub_cond_med$group=="A_control" | all_sub_cond_med$group=="A_first" | all_sub_cond_med$group=="A_second" | all_sub_cond_med$group=="A_third" | all_sub_cond_med$group=="A2_first" | all_sub_cond_med$group=="A2_second"| all_sub_cond_med$group=="A3_first"],5)
      all_sub_cond_med$subind[all_sub_cond_med$subind == "187_2"] = "c_187"
      ...
      all_sub_cond_med$subind[all_sub_cond_med$group=="H2_second" | all_sub_cond_med$group=="H3_first"]=substrLeft(all_sub_cond_med$subind[all_sub_cond_med$group=="H2_second"| all_sub_cond_med$group=="H3_first" ],12)
      ...
      all_sub_cond_med$subind[all_sub_cond_med$group=="H2_first" | all_sub_cond_med$group=="H2_second" | all_sub_cond_med$group=="H3_first"]=substrRight(all_sub_cond_med$subind[all_sub_cond_med$group=="H2_first" | all_sub_cond_med$group=="H2_second"| all_sub_cond_med$group=="H3_first"],7) 
...
#legend.title = element_text(size = rel(1.5)), legend.key.height = unit(2, "line"), legend.key.width = unit(2, "line"), legend.text = element_text(size=10))
                        ggsave(filename=sprintf("%s/figures/Project_4/SC/RT/A_avg_rt_box_no_legend.pdf",wd),width=5,height=5)



      #A_sess_RT_box_nolegend_wu = ggplot(all_sub_mean_wu[all_sub_mean_wu$city=="austin",], aes(x = group2, y = rt_mean)) + geom_boxplot(aes(fill = group2)) + scale_fill_manual(values=c("#999999","#339900", "#3366FF")) + geom_point(data= all_sub_mean_wu[((all_sub_mean_wu$ID2 =="0" | all_sub_mean_wu$ID2=="1" | all_sub_mean_wu$ID2=="c")),], aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean_wu[((all_sub_mean_wu$ID2 =="0" | all_sub_mean_wu$ID2=="1")),],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Response Time (s)") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
      #                  ggsave(filename=sprintf("%s/figures/Project_4/SC/RT/A_avg_rt_box_no_legend_wu.pdf",wd),width=5,height=5)
...
#legend.title = element_text(size = rel(1.5)), legend.key.height = unit(2, "line"), legend.key.width = unit(2, "line"), legend.text = element_text(size=10)) + + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
      ...
      A_sess_ACC_box_nolegend = ggplot(all_sub_mean[all_sub_mean$city=="austin",], aes(x = group2, y = acc_mean)) + geom_boxplot(aes(fill = group2)) + scale_fill_manual(values=c("#999999","#339900", "#3366FF")) + geom_point(data= all_sub_mean[((all_sub_mean$ID2 =="0" | all_sub_mean$ID2=="1" | all_sub_mean$ID2=="c")),], aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean[((all_sub_mean$ID2 =="0" | all_sub_mean$ID2=="1")),],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Accuracy") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)

#legend.title = element_text(size = rel(1.5)), legend.key.height = unit(2, "line"), legend.key.width = unit(2, "line"), legend.text = element_text(size=10))
                         ggsave(filename=sprintf("%s/figures/Project_4/SC/ACC/A_avg_acc_box_no_legend.pdf",wd),width=5,height=5)



      #A_sess_ACC_box_nolegend_wu = ggplot(all_sub_mean_wu[all_sub_mean_wu$city=="austin",], aes(x = group2, y = acc_mean)) + geom_boxplot(aes(fill = group2)) + scale_fill_manual(values=c("#999999","#339900", "#3366FF")) + geom_point(data= all_sub_mean_wu[((all_sub_mean_wu$ID2 =="0" | all_sub_mean_wu$ID2=="1" | all_sub_mean_wu$ID2=="c")),], aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean_wu[((all_sub_mean_wu$ID2 =="0" | all_sub_mean_wu$ID2=="1")),],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Accuracy") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
       #                  ggsave(filename=sprintf("%s/figures/Project_4/SC/ACC/A_avg_acc_box_no_legend_wu.pdf",wd),width=5,height=5)
      ...
      A_rep_RT_box_nolegend = ggplot(all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",], aes(x = group2, y = rt_mean)) + geom_boxplot(aes(fill = group2)) + scale_fill_manual(values=c("#CC6699", "#FFCCFF")) + geom_point(data= all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",], aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Response Time (s)") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
                         ggsave(filename=sprintf("%s/figures/Project_4/SC/RT/A_rep_avg_rt_box_no_legend.pdf",wd),width=5,height=5)



      A_rep_RT_box_nolegend_wu = ggplot(all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], aes(x = group2, y = rt_mean)) + geom_boxplot(aes(fill = group2)) + scale_fill_manual(values=c("#CC6699", "#FFCCFF")) + geom_point(data= all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Response Time (s)") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
                         ggsave(filename=sprintf("%s/figures/Project_4/SC/RT/A_rep_avg_rt_box_no_legend_wu.pdf",wd),width=5,height=5)
      ...
      A_rep_acc_box_nolegend = ggplot(all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",], aes(x = group2, y = acc_mean)) + geom_boxplot(aes(fill = group2)) + geom_point(data= all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",], aes(color=ID2, shape=ID2),size=4.5) + scale_fill_manual(values=c("#CC6699", "#FFCCFF")) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean[all_sub_mean$city=="austin" & all_sub_mean$rep=="r",],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Accuracy") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
                         ggsave(filename=sprintf("%s/figures/Project_4/SC/ACC/A_rep_avg_acc_box_no_legend.pdf",wd),width=5,height=5)

     # A_rep_acc_box_nolegend_wu = ggplot(all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], aes(x = group2, y = acc_mean)) + geom_boxplot(aes(fill = group2)) + geom_point(data= all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], aes(color=ID2, shape=ID2),size=4.5) + scale_fill_manual(values=c("#CC6699", "#FFCCFF")) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",],aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Accuracy") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
      #                   ggsave(filename=sprintf("%s/figures/Project_4/SC/ACC/A_rep_avg_acc_box_no_legend_wu.pdf",wd),width=5,height=5)
  ...
  # AUSTIN and HOUSTON Pre Struggling Readers vs. Controls

     str(all_sub_mean)
     all_sub_mean$group = as.factor(all_sub_mean$group)
     levels(all_sub_mean$group)
     relevel(all_sub_mean$group, ref = "A_control")

      All_sess_RT_box_aug15 = ggplot(all_sub_mean[all_sub_mean$group2 == "first" | all_sub_mean$group2 == "control",], aes(x = city, y = rt_mean)) + geom_boxplot(aes(fill = group)) + geom_point(data= all_sub_mean, aes(color=ID2, shape=ID2),size=4.5) + scale_colour_manual(values=c("black","black","black")) + scale_shape_manual(values=c(17,2,1))+ geom_line(data= all_sub_mean,aes(group = subind, color = ID2, linetype = ID2)) + xlab("Group") + ylab("Mean Response Time (s)") + theme_classic() + theme(axis.title.y = element_text(size = rel(2.0), vjust=0.4), axis.title.x = element_text(size = rel(2.0)), axis.text.x = element_blank(), axis.ticks.x = element_blank(), axis.text.y = element_text(size = 15)) 
#legend.title = element_text(size = rel(1.5)), legend.key.height = unit(2, "line"), legend.key.width = unit(2, "line"), legend.text = element_text(size=10)) + + guides(group = FALSE, fill = FALSE, color=FALSE, shape=FALSE, linetype=FALSE)
...
# T-TEST stats	
     ...
     sink("/corral-repl/utexas/ldrc/SCRIPTS/Stats/SC/rt_acc_austin_wu.txt")
     print(all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "first" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "control",])

     rt_s1vc_a = t.test(rt_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "first" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "control",])
     print("Mean RT - S1 vs. Controls")
     print(rt_s1vc_a)

     acc_s1vc_a = t.test(acc_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "first" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "control",])
     print("Mean Accuracy - S1 vs. Controls")
     print(acc_s1vc_a)

     rt_s2vc_a = t.test(rt_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "second" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "control",])
     print("Mean RT - S2 vs. Controls")
     print(rt_s2vc_a)

     acc_s2vc_a = t.test(acc_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "second" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "control",])
     print("Mean Accuracy - S2 vs. Controls")
     print(acc_s2vc_a)

     rt_s1vs2_a = t.test(rt_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "first" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "second",])
     print("Mean RT - S1 vs. s2")
     print(rt_s1vs2_a)

     acc_s1vs2_a = t.test(acc_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "first" | all_sub_mean_wu$city=="austin" & all_sub_mean_wu$group2 == "second",])
     print("Mean Accuracy - S1 vs. S2")
     print(acc_s1vs2_a)
     ...
     # REPEAT and UNIQUE subs AUSTIN WU

     sink("/corral-repl/utexas/ldrc/SCRIPTS/Stats/SC/sc_rt_acc_austin_repeats_wu.txt")

     print(all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",])

     rt_repeat_a = t.test(rt_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], paired=T)
     print("Mean RT - S1 vs. S2 Repeats")
     print(rt_repeat_a)

     acc_repeat_a = t.test(acc_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="r",], paired=T)
     print("Mean Accuracy - S1 vs. S2 Repeats")
     print(acc_repeat_a)
  
     sink()

     sink("/corral-repl/utexas/ldrc/SCRIPTS/Stats/SC/sc_rt_acc_austin_uniq_wu.txt")

     print(all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="u" & all_sub_mean_wu$group2!="control",])

     rt_uniq_a = t.test(rt_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="u" & all_sub_mean_wu$group2!="control",])
     print("Mean RT - S1 vs. S2 Unique")
     print(rt_uniq_a)

     acc_uniq_a = t.test(acc_mean ~ group2, data = all_sub_mean_wu[all_sub_mean_wu$city=="austin" & all_sub_mean_wu$rep=="u" & all_sub_mean_wu$group2!="control",])
     print("Mean Accuracy - S1 vs. S2 Unique")
     print(acc_uniq_a)
