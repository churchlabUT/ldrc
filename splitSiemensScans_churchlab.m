function splitSiemensScans_churchlab(dirname)
...
%   CHURCH LAB VERSION: 31 July 2015: changed to make folders with just the
%   series number and not the run label for setup_subject. JACL
%
...
%dirname = ('/corral-repl/utexas/ldrc/TWINS/235122/raw/235122')
d=dir(dirname);
