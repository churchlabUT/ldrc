...
do  
  ...
  do
    ...
    if [ "$numfiles" -ge 1 ]  && [ "$numfiles" -le 4 ] ; then
      echo python /corral-repl/utexas/ldrc/SCRIPTS/mk_H_SC_onsets.py ${sub}/behav/SC/SC_Run${runnum}/*subdata.pkl ${sub}/behav/SC/SC_Run${runnum} >> launch_H_SC_onsets.txt
    fi
