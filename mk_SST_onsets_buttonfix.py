...
#For trials with RT values, 0-go_incorrect 1-go_correct 2-stop_fail_incorrect 3-stop_fail_correct
    if rt_loop>0:      
        ...
        if (cond==0 and resp_vec=='3') or (cond==1 and resp_vec=='4'): 
            correct.append(1)
        elif (cond==2 and resp_vec=='4') or (cond==3 and resp_vec=='3'):
            correct.append(2)
        elif (cond==2 and resp_vec=='3') or (cond==3 and resp_vec=='4'):
            correct.append(3)
        else:
            correct.append(0)
...
#For trials with RT values, 0-go_incorrect 1-go_correct 2-stop_fail_incorrect and stop_fail_correct
    if rt_loop1>0:      
        ...
        if (cond==0 and resp_vec1=='3') or (cond==1 and resp_vec1=='4'): #left arrow, left button or right arrow right button
            correct1.append(1) #go correct
            f.write('%.2f\t%s\t%s\t%f\n'%(trueons,correct1[t],'1',rt_loop1))
        elif (cond==2 and resp_vec1=='4') or (cond==3 and resp_vec1=='3'): #Left X R Button or Right X and L button
            correct1.append(2) #stopfail incorrect
            f.write('%.2f\t%s\t%s\t%s\n'%(trueons,correct1[t],'1',''))
        elif (cond==2 and resp_vec1=='3') or (cond==3 and resp_vec1=='4'):
