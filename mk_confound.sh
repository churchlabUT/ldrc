...
fsl_motion_outliers -i $1 -o $dir_loc/scrub_files/fd_confounds.txt --fd --thresh=$fd_thresh -v >$dir_loc/scrub_files/out_confound.txt 2>&1 -s $dir_loc/scrub_files/fd_series.txt -p $dir_loc/scrub_files/fd_plot.png
