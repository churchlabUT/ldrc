#This will create a text file that can be launched on tacc to make all the SST onset files. 

# change the cope and task depending on which one you're working on

rm /corral-repl/utexas/ldrc/SCRIPTS/lev2_copes.txt
...
#subnums=`ls -d ${basedir}/LDFHO*_[0-1]`
