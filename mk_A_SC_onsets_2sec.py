...
#create RT correct/incorrect (includes correct, and incorrect/mismatch, and uses 1 instead of mean RT in dur)

rt_all_rt=rt_vec[[((correct==1) | (correct==0) | (correct==2))]]

rt_all_ons=onset_vec[[((correct==1) | (correct==0) | (correct==2))]]+2
rt_all_pm=rt_vec[[((correct==1) | (correct==0) | (correct==2))]]
rt_all_dur=N.zeros((rt_all_ons.shape))+1
if len(rt_all_pm)>1:
...
incor_dur=N.zeros((incor_ons.shape))+8
